...
Public Property Get TrackKey() As pcTrackKeyboard
'---------------------------------------------------------------------------------------
' Date      : 9/2/05
' Purpose   : Return a shared reference to an object that tracks a key until it is released.
'---------------------------------------------------------------------------------------
    Static o As pcTrackKeyboard
    If o Is Nothing Then Set o = New pcTrackKeyboard
    Set TrackKey = o
End Property
